...
Wetzler helps an AI writing assistant revise Markdown without turning the draft into generic AI prose.

Think of it as a visible checklist for voice:

- You describe the voice in plain files.
- Vale checks the draft for repeatable patterns, like filler, hype, or product terms.
- Wetzler gives an agent a revision packet that says what to preserve and what to improve.
- A human still reviews and approves lasting voice changes.

The important idea: Wetzler does not secretly rewrite your work by itself. It prepares the instructions and evidence an agent should use before it rewrites.
...
Use `prepare` when you want an agent to revise. Use `lint` when you only want to see what the rules flag.
